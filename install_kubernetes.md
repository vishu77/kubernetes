...
<p>On all nodes which would be part of this cluster, you need to do the base setup as described in the following steps. To simplify this, you could also   <a href="https://github.com/vishu77/kubernetes">download and run this script</a></p>
